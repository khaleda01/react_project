...
switch($method)
{
   case "GET": 
    ...
    case "POST":
        ...
        $result= mysqli_query($db_conn, "INSERT INTO user (username, useremail, status) 
        ...
        break;
         ...
         case "PUT":
          $userUpdate= json_decode(file_get_contents("php://input"));
           ...
           $updateData= mysqli_query($db_conn, "UPDATE user SET username='$username', useremail='$useremail', status='$status' WHERE userid='$userid'  ");
           if($updateData)
           {
